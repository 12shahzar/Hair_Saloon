          ...
          {BASIC_MEMBERSHIP.map((data, index) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className={`absolute bottom-[-5px] md:bottom-[-10px] left-1/2 transform -translate-x-1/2 text-[7px] w-full md:text-xs font-futura font-medium ${
          ...
          {PREMIUM_MEMBERSHIP.map((data, index) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className={`absolute bottom-[-5px] md:bottom-[-10px] left-1/2 transform -translate-x-1/2 w-full text-[7px] md:text-xs font-futura font-medium ${
                    isSelected ? "text-[#EB1C24]" : "text-black"
                  }`}
                >
                  {data.small}
